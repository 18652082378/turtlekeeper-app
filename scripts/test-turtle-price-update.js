...
function submit(price) {
  ...
  ctx.submitTurtleDetail({ preventDefault() {}, currentTarget: { speciesCode: 'GHG', weight: '0', carapaceLength: '0', health: '健康', price } });
}
submit('180.25');
...
console.log('Turtle price update checks passed: price-only saving, zero, input validation, linked ledger, batch delta, retained rounding, unchanged sales and growth records.');
